  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await vaultRepository.create({
        ...
        username_encrypted: username || undefined,
        email_encrypted: email || undefined,
        password_encrypted: password || undefined,
        api_secret_encrypted: apiSecret || undefined,
        url: url || undefined,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-50 w-full max-w-lg max-h-[85vh] overflow-y-auto rounded-lg border bg-background p-6 shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <FormField label="Password / API Key" value={password} onChange={setPassword} type="password" />
            <FormField label="API Secret" value={apiSecret} onChange={setApiSecret} type="password" />
          </div>
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <Button type="submit" disabled={!label || isSubmitting}>
