...
class ReportPDFService:
    ...
    def _add_title(pdf: _ReportPDF) -> None:
        # Logo + "Mizan OS" branding top-right
        import os
        logo_path = os.path.join(os.path.dirname(__file__), "mizan_logo.png")
        y_start = pdf.get_y()
        if os.path.exists(logo_path):
            pdf.image(logo_path, x=pdf.w - pdf.r_margin - 45, y=y_start, w=8)
        pdf.set_font("Helvetica", "B", 9)
        pdf.set_text_color(75, 85, 99)
        pdf.set_xy(pdf.w - pdf.r_margin - 36, y_start + 1)
        pdf.cell(36, 5, "Mizan OS", align="L")
        pdf.set_font("Helvetica", "I", 7)
        pdf.set_text_color(130, 130, 130)
        pdf.set_xy(pdf.w - pdf.r_margin - 45, y_start + 6)
        pdf.cell(45, 4, "Generated by Mizan OS", align="L")
        pdf.set_xy(pdf.l_margin, y_start + 12)
